            ...
            <div class="content_info">
                ...
                <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0"
                    ...
                    <tr>
                        ...
                        <td>
                            <s:if test="%{user.headImg != null && user.headImg != ''}">
                                <img src="${basePath }upload/<s:property value='user.headImg'/>" width="100"
                                     height="100"/>
                    ...
                    <tr>
                        ...
                        <td><s:radio list="#{'0':'男','1':'女'}" name="user.gender"/></td>
                    </tr>
                    <tr>
                        <td class="tdBg" width="200px">角色：</td>
                        <td>
                            <s:radio list="#roleList" name="userRoleIds" listKey="roleId" listValue="name"></s:radio>
                        </td>
                    </tr>
                    <tr>
