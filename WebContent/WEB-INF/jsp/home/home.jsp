                    ...
                    <td width="76" height="100" align="center" valign="middle">
                        <div class="left-tx">
                            <s:if test="%{#session.SYS_USER.headImg != null && #session.SYS_USER.headImg !=''}">
                                <img src="${ctx}/upload/<s:property value='#session.SYS_USER.headImg'/>" width="70"
                                     height="70"/>
                            </s:if><s:else>
            ...
            <table width="98%" border="0" align="center">
                <s:iterator value="#complainList">
                    <tr>
                        ...
                        <td width="180px"><s:property value="is_Nm?'匿名投诉':'非匿名投诉'"/></td>
...
<!-- 尾部{ -->
<div class="foot">版权所有©国税局 2014<s:debug></s:debug></div>
<!-- }尾部 -->
</body>
</html>